...
(function(ionic) {
  ...
  ionic.Gestures.defaults = {
    // add less to the element to prevent the browser from doing
  ...
  ionic.Gestures.Instance = function(element, options) {
    ...
    // add some less to the element to prevent the browser from doing its native behavoir
  ...
  ionic.Gestures.utils = {
    ...
    /**
     * stop browser default behavior with less class
     * @param   {HtmlElement}   element
...
(function(window, document, ionic) {
  ...
  var self = ionic.Platform = {
     ...
     * (most less features enabled), 'c' is the worst.  By default, sets the grade
